  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-4",
        month_caption: "flex justify-center pt-1 relative items-center justify-between px-2",
        ...
        day_button: cn(
          ...
          "h-8 w-8 p-0 font-normal aria-selected:opacity-100 hover:bg-primary/20 hover:text-primary transition-colors"
        ),
