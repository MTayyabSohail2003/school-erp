...
import { useTeacherNotices, useNoticesRealtime } from '../api/use-notices';
...
export function TeacherNoticeBoardPage() {
    useNoticesRealtime();
    ...
    const { data: notices, isLoading } = useTeacherNotices(dateQuery);
            ...
            <div className="space-y-6 max-w-3xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold tracking-tight">Teachers Notice Board</h1>
                            <p className="text-sm text-muted-foreground">
                                Official announcements & leave summaries from Admin
                            </p>
                        </div>
                    </div>
                ...
                {isLoading ? (
                    ...
                    <Card>
                        <CardContent className="flex flex-col items-center justify-center py-16 text-center">
                            ...
                            <p className="text-sm text-muted-foreground/70 mt-1">
                                Admin will post notices and leave summaries here.
                            </p>
                        </CardContent>
                    </Card>
                ) : (
                    <div className="space-y-3">
                        {notices?.map((notice, idx) => (
                            ...
                            >
                                <Card 
                                    className="hover:shadow-md transition-all cursor-pointer border-l-4 border-l-purple-500/40 hover:border-purple-500/60 group/card"
                                        ...
                                        <div className="flex items-start gap-3">
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center gap-2 mb-1 flex-wrap">
                                                    ...
                                                    <h3 className="font-semibold text-sm group-hover/card:text-purple-600 transition-colors uppercase tracking-tight">{notice.title}</h3>
                ...
                <Dialog open={!!selectedNotice} onOpenChange={(open) => !open && setSelectedNotice(null)}>
                    <DialogContent className="max-w-2xl bg-card border-purple-500/20">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex-1 min-w-0 pr-6">
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        <Badge variant="secondary" className="bg-purple-500/10 text-purple-600 px-2 py-0 border-purple-500/20 text-[10px]">
                                            Teacher Notice
                                        </Badge>
