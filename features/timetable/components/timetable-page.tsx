...
export function TimetablePage() {
    ...
    // For teachers, always select their own profile. For admins, select first teacher.
    if (isTeacher && profile?.id && selectedTeacherId !== profile.id) {
        setSelectedTeacherId(profile.id);
    } else if (!isTeacher && !selectedTeacherId && teachers && teachers.length > 0) {
