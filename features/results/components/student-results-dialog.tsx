                                                        ...
                                                        <TableRow key={subject.id} className="hover:bg-primary/5 border-b border-border/40 group transition-all duration-300">
                                                            ...
                                                            <TableCell className="text-right py-5 px-8">
                                                                <div className="flex flex-col items-end">
                                                                    <Badge className={`rounded-lg px-3 py-1 text-[11px] font-black uppercase tracking-widest mb-1 border-none ${percentage >= 85 ? 'bg-emerald-500 text-white shadow-lg' :
                                                            ...
                                                            {(() => {
                                                                ...
                                                                return (
                                                                    <div className="flex items-center justify-end gap-8">
                                                                        <div className="flex flex-col items-end">
                                                                            <Badge className={`rounded-[1rem] px-6 py-2 text-sm font-black uppercase tracking-[0.2em] italic shadow-2xl border-none ${isPassed ? 'bg-emerald-500 text-white' : 'bg-red-500 text-white'
                                                                                }`}>
                            ...
                            <div className="col-span-9 grid grid-cols-2 gap-y-4 gap-x-8 px-5 py-4 bg-slate-50/50 rounded-xl border border-slate-300">
                                ...
                                <div className="flex flex-col border-b border-slate-300 pb-1.5">
                                    ...
                                    <span className="text-lg font-black uppercase tracking-tight leading-tight">
                                        {((studentDetail as any)?.classes?.name || (results?.[0] as any)?.classes?.name || 'N/A').toUpperCase()} | SEC: {((studentDetail as any)?.classes?.section || (results?.[0] as any)?.classes?.section || 'N/A').toUpperCase()}
                                    </span>
                                </div>
                                <div className="flex flex-col border-b border-slate-300 pb-1.5">
